...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('-n', '--num', type=int, required=True, help='Specify the number of fake records to create.')
        parser.add_argument('-d', '--del', action='store_true', required=False, help='Flag for deleting existing data')
